...
def mock_database_context():
    ...
    # get_all returns List[Symbol] ORM objects
...
async def test_trade_collector_handles_volume_field():
    """Test that TradeCollector correctly handles 'volume' field in trades."""
